...
recruitment_session2 = TSession.create!(system_name: "異界戦記カオスフレアSC", scenario_name: "テストシナリオ3", t_session_status: "recruit")
progress_session = TSession.create!(system_name: "ソード・ワールド2.0", scenario_name: "テストシナリオ4", t_session_status: "progress")
past_session = TSession.create!(system_name: "アリアンロッドRPG 2E", scenario_name: "テストシナリオ5", t_session_status: "end")
...
Player.create!(user_id: user.id, t_session_id: recruitment_session2.id, player_type: "Game Master", player_status: "join")
...
Player.create!(user_id: user.id, t_session_id: recruitment_session.id, player_type: nil, player_status: "rsvp")
Player.create!(user_id: user.id, t_session_id: recruitment_session2.id, player_type: nil, player_status: "rsvp")

user = User.create!(name: "test_user", nick_name: "Test Player2", email: "test2@player.com", password: "test")
Player.create!(user_id: user.id, t_session_id: recruitment_session.id, player_type: nil, player_status: "rsvp")
